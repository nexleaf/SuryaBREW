...
TARGET         = multipeek
OBJS           = AEEMOD~1.o AEEAPP~1.o MULTIP~1.o GCCResolver.o 
...
#-----------------------------------------------------------------------
clean:
	del $(APP_OBJS) $(TARGET).$(EXETYPE) $(TARGET).$(MODULE)		

copy:
	copy multipeek.mod appfiles
	copy ..\multipeek.mif appfiles
#	copy multipeek.bar appfiles
...
RULE1 = z:\PROGRA~2\BREW31~1.5\sdk\src
{$(RULE1)}.c.o:
	@echo ---------------------------------------------------------------
	@echo OBJECT $(@F)
...
RULE2 = z:\PROGRA~2\BREW31~1.5\sdk\examples\MULTIP~1
{$(RULE2)}.c.o:
	@echo ---------------------------------------------------------------
	@echo OBJECT $(@F)
...
$(BREWDIR)\src\aeeapp~1.o:  \
 $(BREWDIR)/src/aeeapp~1.c \
  $(BREWDIR)/inc/aee.h \
  ...
  $(BREWDIR)/inc/nmdef.h
$(BREWDIR)\examples\multip~1\multip~1.o:  \
 $(BREWDIR)/examples/multip~1/multip~1.c \
  $(BREWDIR)/inc/aeemodgen.h \
  $(BREWDIR)/inc/aee.h \
  $(BREWDIR)/inc/aeegroupids.h \
  $(BREWDIR)/inc/aeeclassids.h \
  ...
  $(BREWDIR)/examples/multip~1/aeemultipeek.h \
  $(BREWDIR)/inc/aeesource.h \
  $(BREWDIR)/inc/aeenet.h \
  $(BREWDIR)/inc/aeenetworktypes.h \
  $(BREWDIR)/inc/net_urgent.bid \
  $(BREWDIR)/examples/multip~1/multipeek.bid \
  $(BREWDIR)/examples/multip~1/aeemultipeek_intl.h
